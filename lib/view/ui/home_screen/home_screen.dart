  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
      builder: (context, child) => Scaffold(
        ...
        body:Obx(() =>  newsController.searchController.value.text.isNotEmpty
          ...
          itemBuilder: (context, index) {
            ...
            final date = DateTime.parse(newsController.results[index].publishedDatetimeUtc.toString());
