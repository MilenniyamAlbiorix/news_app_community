  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: (){
        return  newsController.fetchTopHeadline();
        },
        child: Column(
          ...
          children: [
            ...
            newsController.topHeadlinesList.isNotEmpty ? Expanded(
              ...
              heightFactor: MediaQuery.of(context).size.height * 0.04,
            child:  const Text(BaseStrings.noDataFound,style: TextStyle(color: BaseColors.blackColors),),
            ),
          ],
        ),
      ),
